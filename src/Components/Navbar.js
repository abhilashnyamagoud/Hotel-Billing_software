...
const Navbar=(props)=>{
    ...
    return(
        <div>
                    ...
                    <ul className='navbar-nav ml-auto'>
                        ...
                        </li>
                        {
                            toggle ?<><li className='nav-item'>
                               ...
                               <li className='nav-item'><Link to='/bills' className='nav-link'>All Bills </Link> </li>
                                </>:<>  <li className='nav-item'>
            ...
            <PrivateRoute path='/bills' component={BillDisplay} exact />
            <PrivateRoute path='/bills/:id' component={GenerateBill} exact />
